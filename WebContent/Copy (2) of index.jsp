...
<table width="400" height="120" align="center">
	...
	<tr align="center" height="40">
		<td align="center"><FONT size="2" color="blue" " face="verdana"
			color="blue"> Numero de Clausulas (M): &nbsp</FONT> <input
			type="text" name="M" id="M" size="40" value="${M}"
			style="width: 100px;" maxlength="55"> <br>
		<br>
		<FONT size="2" color="blue" " face="verdana" color="blue">
		Numero de Atomos (N): &nbsp &nbsp</FONT> <input type="text" name="N" id="N"
			size="40" value="${N}" style="width: 100px;" maxlength="55">
		<br>
		<br>
		<FONT size="2" color="blue" " face="verdana" color="blue">
		Numero de Literais (K): &nbsp &nbsp</FONT> <input type="text" name="K" id="K"
			size="40" value="${K}" style="width: 100px;" maxlength="55">
		...
		<input type="image" src="imagens/adiciona.JPG" onclick="/action?metodo=gerarCnf;">
...
<table align="center" width="800" height="150">
	<tr>
		<TD><br>
		</TD>
	</tr>
